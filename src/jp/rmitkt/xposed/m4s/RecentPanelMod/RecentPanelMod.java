package jp.rmitkt.xposed.m4s.RecentPanelMod;
        ...
        try {
            ...
            XposedBridge.hookAllConstructors(recentPanelViewClass, new XC_MethodHook() {
                ...
                protected void afterHookedMethod(final MethodHookParam param) throws Throwable {
                    ...
                    mGbContext = context.createPackageContext(Mod4SystemUI.PACKAGE_NAME, Context.CONTEXT_IGNORE_SECURITY);
            ...
            XposedHelpers.findAndHookMethod(recentPanelViewClass, "onFinishInflate", new XC_MethodHook() {
                ...
                protected void afterHookedMethod(final MethodHookParam param) throws Throwable {
                    ...
                    ViewGroup vg = (ViewGroup) view.findViewById(res.getIdentifier("recents_bg_protect", "id", Mod4SystemUI.CLASSNAME_SYSTEMUI));

                    // GM2 already has this image view so remove it if exists
                    if (Build.DISPLAY.toLowerCase().contains("gravitymod")) {
                        View rcv = vg.findViewById(res.getIdentifier("recents_clear", "id", Mod4SystemUI.CLASSNAME_SYSTEMUI));
                        if (rcv != null) {
                    ...
                    mRecentsClearButton.setImageDrawable(res.getDrawable(res.getIdentifier("ic_notify_clear", "drawable", Mod4SystemUI.CLASSNAME_SYSTEMUI)));
